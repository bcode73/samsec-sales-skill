...
| Descript | AI transcription + text-based audio/video editing | Yes (60 min/mo) | $16/mo annual ($24 monthly) | REST (beta) + MCP | None (429 + Retry-After) | None (HubSpot publish only) | Editing recorded calls/content by editing the transcript, filler-word removal, AI summaries, voice clone (Overdub), video translation (Business) |
