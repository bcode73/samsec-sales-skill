...
### Transformations
En-route transformations using JavaScript or Python functions. Applied before events reach destinations. JavaScript Transformations are available on all plans (including Free); **Python Transformations are Enterprise-only** (verified 2026-06-13).
...
### Profiles (Enterprise plan, cloud only)
Identity resolution and customer 360 built on your warehouse. Profiles & Data Apps is gated to the **Enterprise** plan (verified 2026-06-13).
...
|---|---|---|---|
| **Free (Cloud)** | $0 | 250,000 | Event Streams (16+ SDK sources), 200+ cloud destinations, warehouse destinations, Reverse ETL, JavaScript Transformations, community support |
| **Free (Open-source)** | $0 | Unlimited | Event Streams, Reverse ETL core, self-hosted |
| **Starter** | $220/mo | 1M | Everything in Free + unlimited tracking plans, email support, 99.95% uptime SLA |
| **Growth** | Custom | Custom | Everything in Starter + unlimited team members, unlimited Transformations, unlimited Reverse ETL connections, dedicated support |
| **Enterprise** | Custom | Enterprise-grade | Everything in Growth + Python Transformations, Profiles & Data Apps, HIPAA, SSO |

**Self-serve (Pro)**: You can purchase up to 100M events/month with a credit card; above that, contact sales. Third-party listings cite indicative Starter volume steps (e.g. ~$750/mo at 5M, ~$1,250/mo at 10M, ~$4,500/mo at 50M) but these are not published on the official pricing page — verify in the billing UI.

> **Plan gating (verified 2026-06-13):** Profiles & Data Apps and Python Transformations are **Enterprise-only** (not Growth). JavaScript Transformations and Reverse ETL are available on every plan including Free.
