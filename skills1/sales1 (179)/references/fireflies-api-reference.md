...
* **Free Plan:** Ideal for testing and light usage, with a cap of 50 API requests per day. This rate is suitable for testing and small-scale applications.
* **Pro Plan:** Suited for moderate to heavy usage, with a cap of 500 API requests per day (raised from 50 in API v2.24.1).
