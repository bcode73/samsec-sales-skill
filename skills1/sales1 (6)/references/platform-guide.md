...
Verified against the live pricing page on 2026-06-13. AdButler now lists **four named tiers** (Advanced is a concrete published tier, not "custom").

| Feature | Essentials ($179/mo) | Standard ($682/mo) | Advanced ($2,988/mo) | Enterprise |
|---|---|---|---|---|
| Ad requests | 1M | 10M | 50M | Custom (unlimited) |
| Zones | 10 | 100 | 1,000 | Custom |
| Advertisers | 10 | 50 | 100 | Custom |
| Users | 1 | 5 | 5 | Custom |
| Ad formats | Display, mobile, in-app | + Video | + All | + All |
| API Access | **Paid add-on** | **Paid add-on** | Included | Included |
| Targeting | **Paid add-on** | **Paid add-on** | Add-on | Custom |
| Programmatic | **Paid add-on** | **Paid add-on** | Included | Included |
| Financial reporting | No | Yes | Yes | Yes |
| Mobile SDK | No | Yes | Yes | Yes |
| Sandbox account | No | No | No | Yes |

**Key gate:** API Access is included on Advanced and Enterprise but is a **paid add-on on Essentials and Standard** — you cannot use the management API on those tiers without it (per AdButler's subscription add-ons doc: "Enterprise and Advanced subscribers already have this feature").

**Add-ons (Essentials/Standard):** API Access, Targeting, Programmatic, Enhanced Ads, Log Level Data, Contract Management, Self-Serve Marketplace (BETA), Enhanced Analytics, White Label Domains. Exact add-on dollar amounts are not authoritatively published on the help docs — confirm in your account/contract.
