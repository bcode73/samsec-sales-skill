...
- **Plan limits** — Free: 5 flows / 50 elements / 1 event; Standard: 10 flows / 70 elements / 10 events; Pro: 50 flows / 150 elements / 50 events; Enterprise: unlimited (verified against the prices feature-comparison table 2026-06-13)
...
- **Credits** — included in plan (100 on Free and Standard, 1,000 on Pro; Enterprise varies by email plan), additional credits purchasable
...
## Plans & pricing (email service)

Verified against sendpulse.com/prices on 2026-06-13. Prices are per-month, annual billing.

| Plan | Annual price | Subscribers | Emails/mo | Users | Automation flows / elements / events | Email verifications |
|------|-------------|-------------|-----------|-------|--------------------------------------|---------------------|
| Free | $0 | 500 | 15,000 | — | 5 / 50 / 1 | 100 |
| Standard | ~$9.60 ($12 monthly) | 500 | Unlimited | 3 | 10 / 70 / 10 | 100 |
| Pro | ~$11.52 ($14.40 monthly) | 500 | Unlimited | 10 | 50 / 150 / 50 | 1,000 |
| Enterprise | ~$16.13 ($20.16 monthly) | 2,500 min | Unlimited | Unlimited | Unlimited | Varies by plan |

Notes:
- Subscriber-based pricing scales above the entry tier as the audience grows; the prices above are the entry points.
- Pro adds dynamic segmentation, email verification, and dedicated onboarding over Standard.
- Pay-As-You-Go email-credit packs are offered separately (credits valid for one year).
- Chatbot plans are billed separately: Free (3 bots, 1,000 contacts, 10,000 messages/mo, 10 variables) and Pro (unlimited bots/messages).
