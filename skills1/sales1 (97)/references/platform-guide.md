...
**Editions (current official line-up — Essentials, Growth, Enterprise):**

As of 2026 ChurnZero markets three editions — **Essentials**, **Growth**, and **Enterprise** (the older two-tier "Professional/Enterprise" naming has been retired). Growth is positioned for smaller teams/startups as "easier to buy while still being full-featured"; Enterprise targets large teams managing complex, high-volume bases (typically 2,000+ accounts). ChurnZero does not publish a public feature-by-edition matrix, so the gating below combines the official editions positioning with corroborated buyer data (Vendr). Confirm specifics with a quote before relying on edge cases.

| Feature | Essentials | Growth | Enterprise |
|---|---|---|---|
| Health Scores (ChurnScores) | ✓ | ✓ | ✓ |
| Plays & Automation | ✓ | ✓ | ✓ (+ conditional logic) |
| Journeys / journey orchestration | basic | ✓ | ✓ |
| In-App Communications | ✓ | ✓ | ✓ |
| Surveys (NPS/CSAT/CES) | ✓ | ✓ | ✓ |
| Custom reporting / dashboards | limited | ✓ | ✓ (advanced) |
| REST API (OData) | ✗ | ✓ | ✓ |
| Renewal & Forecast Hub | ✗ | ✓/✗ (confirm) | ✓ |
| Advanced integrations | limited | ✓ | ✓ |
| SSO/SAML | varies | ✓ | ✓ |

> **Drift note (2026-06-13):** the REST API and custom reporting are no longer Enterprise-exclusive — Vendr's current ChurnZero data states "Higher tiers unlock advanced automation, custom reporting, and API access," with API access included at **Growth and Enterprise**. The Renewal & Forecast Hub's exact Growth-vs-Enterprise gating is not officially published; verify before quoting.

**Indicative pricing (based on Vendr contract analysis, 2025-2026):**

> These figures predate the Essentials/Growth/Enterprise renaming; the "lower tier" column maps to today's Essentials/Growth band, the right column to Enterprise. Vendr's 2026 median across all buyers is ~$44,625/yr, with small teams (100–500 accounts) $15K–$50K, mid-market (500–2K accounts) $40K–$100K, and 2,000+ accounts $100K+.

| Team size | Lower tier — Essentials/Growth (median) | Enterprise (median) |
|---|---|---|
...
## Data model (API — Growth & Enterprise)
