...
- **AI credits system adds hidden cost.** AI credits are now included per plan, per month (Basic 1,000 / Standard 2,000 / Pro 3,000 selectable up to 20,000 / Enterprise 20,000), shared across all monday AI features. The notetaker burns **120 credits/hour** (~2/min), so Pro's 3,000 ≈ 25 hours of meetings/month. New signups on/after May 6, 2026 must buy AI credits together with seats — they aren't bundled free.
...
**Symptom**: You exhaust your plan's monthly AI credit allowance mid-month and AI features stop working
**Cause**: AI Notetaker consumes **120 credits/hour** (~2/min) from the shared monthly pool (Basic 1,000 / Standard 2,000 / Pro 3,000 / Enterprise 20,000), alongside other monday AI features (formula builder, docs assistant, etc.). At 120/hour, Pro's 3,000 credits is only ~25 hours of meetings.
**Solution**: Check AI credit usage in account settings. Prioritize: some AI features (Formula Builder, Docs Assistant, Deal Insights, Risk Insights) are free and don't consume credits. On Pro you can raise your monthly credit tier (3,000 → 4,000 / 8,000 / 20,000). If notetaker is the primary credit consumer, weigh the higher credit tier vs. a dedicated notetaker ($10-20/user/mo) that doesn't meter per hour.
