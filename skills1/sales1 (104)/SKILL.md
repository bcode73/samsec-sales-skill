...
1. **Check your HubSpot Credits** — Breeze Intelligence enrichment consumes the unified **HubSpot Credits** included with paid seats (the old standalone Breeze credit packs were migrated into HubSpot Credits in June 2025). Buy additional credits if your edition's monthly allotment is short.
...
5. **Monitor credit usage** — credits don't roll over and expire each usage period; overage is $0.010/credit. Adjust volume to match your included monthly allotment.
...
- **Credits don't roll over**: Breeze Intelligence enrichment now draws on the **unified HubSpot Credits** pool (legacy Breeze credit packs migrated into HubSpot Credits between June 2–15, 2025). Credits reset each usage period and unused credits expire — no rollover. Only paid seats can use HubSpot Credits; overage is $0.010/credit (billed in increments of 10). Right-size based on your edition's included monthly credits.
