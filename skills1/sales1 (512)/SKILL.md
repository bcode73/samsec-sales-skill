...
- **Don't overlook the Seismic-Highspot merger.** A definitive intent-to-merge was announced **February 12, 2026** (the combined company keeps the Seismic name, led by Seismic's CEO; Permira stays controlling shareholder). It is subject to regulatory approval, and **both platforms keep operating/being supported until the deal closes** — so today's Seismic features, pricing, and API remain current. Flag that post-close consolidation may later change feature set, pricing, and integrations.
