...
| Historical data (post retention) | 30 days | 60 days | 180 days |
...
- Every new account gets $5 free credit; first 50 requests/month per endpoint are free
- Rate limit: 3 concurrent requests per endpoint per user
- Reddit posts endpoint costs $0.003/request; many endpoints (Reddit comments, X, YouTube, Web, Places) are billed per page, not per request
