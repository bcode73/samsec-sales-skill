...
_Prices below are monthly billing (annual billing is discounted). Verified against the live pricing page 2026-06-13._

| Plan | Monthly | Keywords | Mentions/mo | Users | API |
|---|---|---|---|---|---|
| Basic | $69 | 3 | 5,000 | 2 | No |
| Essential | $169 | 10 | 15,000 | 10 | No |
| Advanced | $299 | 15 | 50,000 | Unlimited | No |
| Pro | $499 | 25 | 100,000 | Unlimited | Yes |
| Business | $749 | 40+ | 200,000+ | Unlimited | Yes |
| Enterprise | $1,299+ | 100+ | Custom | Unlimited | Yes |

**Free trial:** 14 days, 3 keywords, 5,000 mentions, 10 social profiles, 5 users, full feature access, no credit card required.

**API gate:** Pro ($499/mo) and above only — API access is included on Pro, Business, and Enterprise plans. No way to get API access on lower plans. (The former "Agency" tier has been renamed "Business.")
