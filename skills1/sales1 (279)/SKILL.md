...
- **TikTok is now a supported channel.** Konnect Insights monitors TikTok as part of its 30+ channel coverage and publishes dedicated TikTok social-listening guides (konnectinsights.com/blogs/tiktok-social-listening-a-complete-guide/, konnectinsights.com/whitepapers/understanding-social-listening-for-tiktok/). Earlier docs that said TikTok was unsupported are outdated — confirm exact TikTok data depth (mentions vs. hashtag vs. account analytics) for your use case in a demo.
