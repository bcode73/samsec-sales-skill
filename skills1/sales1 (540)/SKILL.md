...
1. **LinkedIn automation is a separate paid add-on (per slot)** — $69/mo per slot on a free plan, or $59/mo per slot when bought with a paid plan (~$62 billed annually). Not included in any base plan. If you build campaigns with LinkedIn steps but haven't purchased the add-on, those steps won't execute. Budget accordingly.
