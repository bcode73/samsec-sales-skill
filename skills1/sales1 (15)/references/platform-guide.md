...
Base plan: $299/mo includes 2M impressions; additional impressions beyond plan are billed at **$0.05 CPM** (the live pricing calculator now shows the base + overage CPM rather than fixed volume tiers — the table above is indicative). CDN bandwidth: $0.03/GB (NA/EU), $0.07/GB (SA/Asia/Oceania). No contracts. 45-day free trial. No setup fees.
