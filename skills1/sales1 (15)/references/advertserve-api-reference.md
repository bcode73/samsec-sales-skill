...
<!-- Source: https://www.advertserve.com/docs/latest/html/manual/api_reports.html -->
<!-- Source: https://www.advertserve.com/docs/latest/html/manual/api_code_banner.html -->
<!-- Source: https://www.advertserve.com/developers.html -->
<!-- Re-verified 2026-06-13 against v5.0 docs -->
...
**Error responses** return HTTP 500. The format follows the requested `output`:
...
- `targeting` (CSV Integer): Targeting codes 1-11 — 1=CUSTOM, 2=DATETIME, 3=GEOGRAPHY, 4=KEYWORDS, 5=NETWORK, 6=REFERRERS, 7=SOFTWARE, 8=THEMES, 9=RETARGETING, 10=LANGUAGES, 11=WEATHER
...
- `bidding_header` (Boolean): Enable Prebid.js header bidding (default false)
- `bidding_category` (String): IAB OpenRTB category
- `bidding_consent_api` (String): empty or `iab` (IAB consent framework)
- `bidding_coppa`, `bidding_privacy`, `bidding_ssl` (Boolean): default false
