---
name: sales-flippa
description: "Flippa marketplace help — the largest open marketplace for buying/selling SaaS, ecommerce, content sites, apps, domains, and social accounts (tens of thousands sold). Covers the tiered listing packages (Entry/Standard/Premium/Ultimate), the sliding success-fee scale (higher percentage on small deals, lower on large), paid add-ons (NDA, legal docs, M&A report, private listing), the brokered service for high-value listings, buyer Premium and due-diligence reports, revenue OAuth verification for larger listings via Stripe/GA/Shopify/Amazon, and FlippaPay/Escrow.com escrow. Use when listing a business on Flippa, auditing a listing for fraud or inflated revenue, picking between Entry/Standard/Premium/Ultimate packages, budgeting the tiered success fee against Acquire.com or Empire Flippers, or preparing financials for the revenue auto-verification badge. Do NOT use for cross-marketplace valuation strategy (use /sales-side-project-valuation)."
