...
- **Free plan is severely limited.** 10 questions per survey, 25 responses per survey, no data export, no skip logic, no custom branding. Most users hit the paywall fast. If you need logic or exports, you need at least Advantage (annual billing).
...
- **API rate limits are tight for private apps.** 120 requests/min, 500/day (starting). Resets at midnight GMT. Public apps published in the App Directory get up to 500,000 requests/day. Plan for batching if pulling large datasets.
...
- **Check your plan's response limits.** Free plan shows only 25 responses per survey. Even paid plans have caps (Standard: 1,000/mo, Advantage: 15,000/yr). Go to My Account → Billing to see usage.
