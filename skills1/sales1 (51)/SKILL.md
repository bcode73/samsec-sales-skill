...
4. **Newsletter slot isn't automatic on the free path** — per BetaList's FAQ, "the newsletter does not include all featured startups, but only the most popular ones." Priority/expedited reviews are always included; free listings are not guaranteed. When you do get in, your tagline and thumbnail drive the clicks
...
**Cause**: Per BetaList's official FAQ, regular submissions can take "up to a few weeks to get reviewed," and once accepted it "typically takes about two months to get featured." Silence for a couple of weeks is normal on the free path.
