...
3. Validates webhook signatures using HMAC-SHA256: `SHA256(timestamp + JSON.stringify(payload) + secretToken)`, comparing against the `x-modjo-payload-signature` header
