...
- **Two pricing models coexist.** The homepage now leads with a one-time pay-per-lead pack — "$20 for 25 warm leads" ($0.80/lead), no subscription, no card on file, larger packs in-dashboard. Separately, a $49/mo founder subscription (100 leads/mo, "next 100 clients", then $79/mo; annual ~$490/yr) still exists on the About/FAQ pages. Pricing is credit-based: you only spend credits to unlock the leads you choose. Pick the $20 pack to test, the subscription for sustained monitoring.
