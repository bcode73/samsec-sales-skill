...
<!-- Pricing re-verified against live prems.ai pages 2026-06-13. Two pricing models now coexist: a one-time pay-per-lead pack (homepage entry point) AND a $49/mo founder subscription (About page / FAQ). -->

### Pay-per-lead packs (credit model — current homepage entry point)

The homepage now leads with a one-time "tripwire" lead pack, not a subscription. Verbatim from prems.ai:

| Pack | Price | Per-lead | Terms |
|---|---|---|---|
| First pack (tripwire) | $20 one-time | $0.80 per warm lead | "One-time. No subscription. No card on file after purchase." — 25 warm leads |
| Larger packs | In-dashboard | — | "Larger packs available inside the dashboard once you've tried us." |

**Credit-unlock mechanic:** "You only pay credits for leads you choose to unlock" (FAQ). Auto-pilot surfaces scored leads; you spend credits only on the ones you unlock. The Scale plan is quoted in credits (750), consistent with this model.

### $49/mo founder subscription (About page / FAQ)
...
The subscription includes "100 leads/month, unlimited keywords, AI Pitcher, and full dashboard access" (FAQ). Founder pricing is "$49/mo for the next 100 clients", then "$79/month after."

**No feature gating within the subscription.** The only subscription limit is 100 leads/month. Choose the $20 tripwire pack to test without a subscription, or the $49/mo plan for sustained monitoring.

**Agency support:** A Scale plan (750 credits) is offered for agencies managing multiple brands, with team collaboration and white-label options — exact pricing unclear.
