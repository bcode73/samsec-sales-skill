...
> **Note**: Thoma Bravo acquired Verint (~$2B) to combine it with Calabrio; the transaction closed Jan 31, 2026, and in February 2026 the combined organization adopted the single corporate name **Verint**. The **Calabrio** product name continues as Verint's midmarket WEM offering. Da Vinci AI bots are being expanded to Calabrio customers. For Verint Open Platform (enterprise) questions, use `/sales-verint`.
