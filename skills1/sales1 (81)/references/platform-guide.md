...
- **Auth**: Personal access tokens (generated in User Settings). For machine-to-machine integrations, use HTTP Basic with username `__token__` and the personal access token as the password.
