...
All prices per user/month, billed annually (Starter Suite is billed monthly or annually). Verified 2026-06-13 against salesforce.com/sales/pricing. A ~6% list-price increase was applied to Enterprise and Unlimited editions as of August 2025.
...
| **Unlimited** | $350/user/mo | Premier support, full sandbox, 24/7 support, unlimited custom apps | Higher API limits, full copy sandbox |
| **Agentforce 1 Sales** (formerly Einstein 1 Sales) | $550/user/mo | Everything in Unlimited + Data Cloud, Agentforce, Slack, Revenue Intelligence | Highest limits |
...
- **GraphQL API**: Newer API for flexible querying (query GA since Winter '23 / v56.0; mutation GA since v66.0).
