...
**Fees:** $2/active-account/month (active = received a payout that month) + 0.25% + $0.25 per payout sent, when the platform manages pricing (verified against stripe.com/connect/pricing, 2026-06-13). Buyer-side processing fees standard.
...
**Fees:** 1.5% of the payout amount in the US (raised from 1% effective June 1, 2024; verified via Stripe support, 2026-06-13). Rates differ by country/payout method.
