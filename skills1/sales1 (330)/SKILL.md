...
| **Tax form generation** (1099-K, 1099-NEC, W-9, W-8) | If you'll cross 1099 thresholds. Trolley, Tipalti, Stripe Connect handle 1099 forms; Wise and Tremendous don't. The 1099-K threshold was briefly lowered ($5K for TY2024) but the One Big Beautiful Bill Act (2025) reverted it to **$20,000 AND 200 transactions**, retroactive to 2022 (IRS IR-2025-107). Separately, the **1099-NEC/1099-MISC threshold rises from $600 to $2,000 starting tax year 2026** (inflation-indexed from 2027). |
...
**The 1099-K threshold reverted to $20,000 AND 200 transactions.** It was briefly lowered ($5K for TY2024 under the American Rescue Plan ramp-down), but the One Big Beautiful Bill Act (signed July 2025) restored the pre-2021 threshold of **$20,000 and more than 200 transactions**, retroactive to 2022 (IRS IR-2025-107 / Fact Sheet 2025-08). The feared drop toward $600 is dead. Separately, the **1099-NEC / 1099-MISC threshold rises from $600 to $2,000 for tax year 2026** (indexed for inflation from 2027). Either way, pick a platform that handles 1099-K and 1099-NEC generation natively (Trolley, Stripe Connect, Tipalti) or budget engineering time to do it yourself — the form-generation requirement persists, just at a higher revenue bar than the panic of 2023-24 implied.
...
3. **The 1099-K threshold went down, then back UP — don't quote the old panic numbers.** The American Rescue Plan ramp-down ($5K for TY2024, planned $2.5K then $600) was REVERSED by the One Big Beautiful Bill Act in 2025. The 1099-K threshold is now back at **$20,000 AND more than 200 transactions**, retroactive to 2022 (IRS IR-2025-107). The $600 1099-K never took effect. Separately, the 1099-NEC/1099-MISC filing threshold rises from $600 to **$2,000 in tax year 2026**. Still pick infra that auto-generates these forms — the bar just moved higher than the 2023-24 guidance implied.
...
**Skill does**: Recommends Stripe Connect Express. Reasoning: US-only at 30 workers means multi-currency isn't a factor, Hyperwallet is overkill, Tipalti's AP-approval flow is wrong for direct worker payouts. Stripe Express has the best onboarding UX (which is what will break first at 30 workers since each onboarding is a churn moment), free until you scale, and 1099-NEC generation is native. Notes that if any worker is outside the US, switch to Hyperwallet or Trolley. Notes that the 1099-K threshold reverted to $20,000 / 200 transactions (OBBBA 2025) so most of these cleaners will get a 1099-NEC, not a 1099-K — and confirms Stripe Express generates both natively.
...
**Cause**: The thresholds moved. The 1099-K threshold was briefly lowered to $5K (TY2024) but the One Big Beautiful Bill Act (2025) reverted it to **$20,000 AND more than 200 transactions** (IRS IR-2025-107), so fewer recipients need a 1099-K than the 2023-24 guidance implied. Meanwhile the 1099-NEC/1099-MISC threshold rises from $600 to **$2,000 starting tax year 2026**. Most gig-worker payouts route to 1099-NEC (your direct payment to the worker), not 1099-K (which is a third-party-settlement form).
