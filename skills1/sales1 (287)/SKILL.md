...
- **Post limits on lower plans.** Starter gets 30 posts/profile/month — that's just 1/day. If you're posting across multiple networks, you'll hit the limit fast. Growth plan (180/profile/mo, 2 social sets) is the practical minimum for active brands.
...
- **Analytics gated to Growth+ plans.** Starter plan gets only basic post metrics (3 months of history). Follower demographics, multi-profile best time to post, hashtag analytics, and story analytics require Growth ($50/mo billed monthly, $37.50/mo annual) or above; competitive benchmarking, brand health, and brand mentions are Scale-only. (Single-profile best time to post is available from Starter.)
