...
- **Native ESP integrations** (subscribers pushed every 10 minutes). Per Payhip's official email-marketing features page and Help Center, the native list is:
  - ActiveCampaign
  - AWeber
  - Campaign Monitor
  - ConvertKit (Kit)
...
ActiveCampaign, AWeber, Campaign Monitor, ConvertKit (Kit), Drip, Elastic Email, Email Octopus, GetResponse, Mad Mimi, Mailchimp, MailerLite, SendFox — subscriber sync every 10 minutes. All other ESPs via Zapier.
...
- Google Analytics
- Facebook Pixel
- (Elastic Email is a native ESP integration — see Native ESP integrations above)
