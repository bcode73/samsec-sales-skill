...
- Buffer setup, API/GraphQL, per-channel pricing, or v1→GraphQL migration → `/sales-buffer`
...
- `/sales-buffer` — Buffer platform help — simple per-channel publishing/scheduling across 11 networks, GraphQL API + legacy REST v1 (no webhooks), free-plan caps, no social listening
