...
3. **What's your Modash plan?**
   - A) Essentials ($199/mo annual, $299 monthly)
   - B) Performance ($499/mo annual, $599 monthly)
   - C) Enterprise (custom, from $14,700/yr)
...
**Skill does**:
1. Reviews the two API products: Discovery (search 380M+ profiles; includes AI Search, Collaborations, and Lookalikes as sections) and Raw (live data for real-time monitoring)
