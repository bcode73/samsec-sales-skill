...
- **Ranked availability, custom domains, and paid bookings require Premium ($17/mo).** Ranked availability (showing preferred times first) is a Premium feature, not Basic. Don't recommend Stripe payment collection, custom scheduling domains, or ranked availability to Basic plan users without noting the upgrade.
