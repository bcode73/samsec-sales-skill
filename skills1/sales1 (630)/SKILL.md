...
2. **Which plan are you on?**
   - A) Starter ($29/mo — 5 pages, 500 visitors, no AI copywriting, no A/B testing)
   - B) Build ($99/mo — unlimited pages, popups, Smart Copy, 20K visitors, no A/B testing)
   - C) Experiment ($149/mo — A/B testing, DTR, 30K visitors)
   - D) Optimize ($249/mo — Smart Traffic AI, 50K visitors)
   - E) Agency / Concierge (enterprise)
   - F) Free trial / not sure yet
