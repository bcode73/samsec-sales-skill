...
- AI copywriting starts on the Build plan ($99/mo); the entry-level Starter plan ($29/mo) does NOT include it
...
*Verified against unbounce.com/pricing on 2026-06-13. Re-verify before relying on exact figures.*

| Plan | Monthly | Annual (per mo) | Pages | Visitors/mo | Users | Root domains | Key features |
|---|---|---|---|---|---|---|---|
| Starter | $29 | $22 | 5 | 500 | 1 | 1 | Drag-and-drop builder, lead-gen forms (no AI copywriting, no A/B testing) |
| Build | $99 | $74 | Unlimited | 20,000 | 1 | 1 | + AI copywriting (Smart Copy), custom code, 1000+ integrations |
| Experiment | $149 | $112 | Unlimited | 30,000 | 3 | 2 | + Unlimited A/B testing, unlimited variants, Dynamic Text Replacement |
| Optimize | $249 | $187 | Unlimited | 50,000 | 5 | 3 | + AI traffic optimization (Smart Traffic), advanced triggers, industry benchmarking |
| Agency | Custom | Custom | Unlimited | 50,000+ | 5+ | 10+ | Client management, partner directory listing |
| Concierge | Custom | Custom | Unlimited | 100,000+ | 15 | 5 | Dedicated success manager, implementation services |

**All plans include**: Unlimited conversions, free hosting, SSL, and customer support. Starter is capped at 5 pages; Build and above are unlimited pages and popups/sticky bars. Smart Copy AI copywriting starts on Build (not Starter).
