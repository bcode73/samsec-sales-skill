...
Treasure Data operates in four regions. Always use the correct region's URLs. (Official developer docs now live at **docs.treasure.ai** — the old docs.treasuredata.com 301-redirects there. The Ingestion API shares the JS SDK host, e.g. `https://us01.records.in.treasuredata.com`.)
...
| LLM API | https://llm-api.treasuredata.com |
...
| LLM API | https://llm-api.eu01.treasuredata.com |
...
| LLM API | https://llm-api.treasuredata.co.jp |
...
| LLM API | https://llm-api.ap02.treasuredata.com |
