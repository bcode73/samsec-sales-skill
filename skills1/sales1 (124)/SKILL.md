...
- **Custom pricing only.** No self-serve paid plans — you must go through sales (convin.ai/pricing shows only "Request a Quote"). The product is packaged into 4 suites (CX, Real-Time, Voice of Customer, Post Interaction); the **Quality Management Software** (single manual-QA platform) is the FREE tier — all AI-powered modules (auto QA, real-time assist, AI phone agent, LMS) require a paid quote.
