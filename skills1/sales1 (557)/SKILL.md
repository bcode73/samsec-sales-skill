...
- **Small list (<5K subs)**: Use SponsorGap's free search (5 hand-picked sponsors, no card) to research which brands sponsor similar-sized newsletters. Focus on niche-specific sponsors where your audience alignment matters more than list size.
- **Mid-size (5K-25K subs)**: Use the **Growth tier ($89/mo, formerly "Pro")** for verified contacts and competitor monitoring. Build a target list of 20-30 brands, then cold email decision-makers using the verified contacts. Growth also includes limited API access and up to 5 seats.
- **Larger (25K+ subs)**: The **Enterprise tier ($199/mo)** adds Full API access, AI-powered recommendations, and unlimited seats to systematize sponsor prospecting. Combine with Paved marketplace for inbound deals. For done-for-you prospecting, Managed Services ($999 / $2,999/mo) builds a custom Airtable CRM and runs outreach.
...
1. **Verified contacts require a paid plan (the $89 Growth tier, formerly "Pro")** — the Starter ($39) plan only browses ~1,000 sponsors with basic contact info, not full verified decision-maker emails/LinkedIn. The free tier gives just 5 hand-picked sponsors. (Tiers were renamed Starter / Growth / Enterprise; prices unchanged $39 / $89 / $199.)
2. **API access is now tiered, not Enterprise-only** — "Limited API access" starts on **Growth ($89/mo)**; "Full API access" is on **Enterprise ($199/mo)**. There is no public API documentation; request docs/credentials from support after subscribing. (Re-verified 2026-06-13 — older copy said API was $199-only.)
3. **No Zapier/Make integration** — you can't connect SponsorGap to your CRM or outreach tool via iPaaS. Use CSV export (paid tiers) or the API (Growth+) to move data. For done-for-you outreach with a custom CRM built in Airtable, SponsorGap offers Managed Services ($999 / $2,999/mo).
