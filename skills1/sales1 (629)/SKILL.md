...
- B) Basic ($29/mo, 100 responses/mo)
- C) Plus ($59/mo, 1,000 responses/mo)
- D) Business ($99/mo, 10,000 responses/mo)
- E) Growth Flow ($349/mo, marketing teams)
- F) Talent ($169/mo, HR teams)
- G) Enterprise (custom)
- H) Not sure
