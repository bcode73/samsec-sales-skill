...
- For WhatsApp: requires Web v2.4+ — WhatsApp was added Oct 31 2025 (v2.4), with voice/video/location/contact messages following in v2.6 (Nov 2025)
...
- **Still actively evolving.** Frequent releases on separate Web/Desktop/Chrome version tracks — latest is v3.0 (June 2026), which added AI Phone Calls and Autonomous Routines (plain-language automation, no builder). Expect feature changes, new integrations, and occasional bugs with newer capabilities.
