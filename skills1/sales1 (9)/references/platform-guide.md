...
- **Publisher commission**: Publisher keeps **70% of the revenue generated by confirmed ad clicks** (per official FAQ); Admailr retains 30%
- **Private marketplace (direct-sold) fee**: Admailr charges a CPM fee with a **minimum of 500,000 impressions per month** for publishers running their own direct deals through the platform
- **Minimum payout**: $100 threshold before payment is issued
- **Payment schedule**: Monthly on the 20th (automatic once balance exceeds $100)
- **Payment methods**: PayPal, ACH, check (PIN required only for check payments; not required for PayPal/ACH — PIN is mailed and arrives within ~2 weeks in the U.S.)
