...
8. **No self-serve pricing** — enterprise-only, typically $40K-$375K+/year (avg ~$156K). Now uses value-based pricing (VBP) with "mParticle Credits" consumed by event volume (Connect/Preserve/Personalize tiers), profile/feature usage, storage, and real-time audiences. mParticle merged with Rokt (~$300M, announced Jan 2025) — now branded "mParticle by Rokt."
