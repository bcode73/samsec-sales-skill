...
| Ahrefs features, API v3, MCP server, API units/credits, or v2→v3 migration | `/sales-ahrefs {question}` |
...
2. **Week 3-4: Keyword research** — Find 20-30 low-competition keywords (KD < 20, volume > 100). Use free tools first (GSC, Ubersuggest free tier, Google autocomplete / "People also ask"). Upgrade to paid only if you need competitor data. (Note: AnswerThePublic dropped its free tier in 2026 — cheapest plan is now $20/mo or a $99 one-time lifetime.)
...
- **Rank Math Free** — best value: unlimited focus keywords, redirects, schema, GSC integration, all free
...
- **SEOPress** — developer favorite: clean code, no upsells, $49/yr (1 site) up to $149/yr (unlimited sites)

**Tool budget tiers:**
- **$0/mo**: Google Search Console + Rank Math + Ubersuggest free + Ahrefs Webmaster Tools
- **$30-50/mo**: Mangools ($29/mo) or Ubersuggest ($29/mo) for keyword research + rank tracking, or Ahrefs Starter ($29/mo) if you mainly want backlink data
- **$50-100/mo**: SE Ranking (entry tier ~$55-65/mo — confirm current price, plans were renamed Core/Growth/Enterprise in 2026) — best value all-in-one with AI features
- **$130-200/mo**: Ahrefs Lite ($129/mo) for backlinks or Semrush Pro ($139.95/mo) for all-in-one + content + API
...
- `/sales-ahrefs` — Ahrefs platform help (Site Explorer/backlinks, REST API v3 + official MCP server, API-units/credit model, v2→v3 migration). Install:
  `npx skills add sales-skills/sales --skill sales-ahrefs -a claude-code`
