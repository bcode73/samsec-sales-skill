...
### AI Crew (usage-based, free Starter tier)
...
- Billed by "runs" (each agent execution = 1 run, covering infrastructure, triggers, scheduling, CRM write-back, routing):
  - Starter: 1,000 runs/mo — included free with every plan
  - Growth: 5,000 runs/mo — €299/mo
  - Scale: 25,000 runs/mo — €999/mo
  - Enterprise: unlimited runs — custom pricing
...
| Plan | Price | Includes |
|---|---|---|
| Coaching & AI | €49/user/mo (monthly) / €39.20/user/mo (annual, 20% off) | AI Assistant, AI Coach, AI Analyst, AI CRM Concierge, **API access**, free licenses for other departments |
| Enterprise | Custom | Everything in Coaching & AI + custom agent implementation, performance audits, agent training, custom onboarding, priority support |
| AI Crew | Usage-based by runs — Starter 1,000 runs/mo free; Growth 5,000 runs €299/mo; Scale 25,000 runs €999/mo; Enterprise unlimited custom | Autonomous workflow agents (free Starter tier included with every plan) |
| Viewer seats | Free | Non-sales team members / meeting invitees don't require seats |

- 14-day free trial, no credit card required (includes full access to AI Crew, Agent Builder, and 1,000 agent runs)
- Annual billing saves ~20% (€49 → €39.20/user/mo)
...
- API access is included in the Coaching & AI plan (not a separate add-on)

### Rate limits (API)
- Global: 120 requests/minute per API key
- Recordings endpoint: 60 requests/minute per API key
...
### Webhook events (10 per V2 OpenAPI spec)
...
Note: the help-center API Reference article currently lists only the 8 core events (omitting the two `demo.*` metadata events). Confirm availability with support.
