...
- **For API questions**: Point to the right API (Collect v3 for ingestion, Visitor Profile for lookups, Visitor Privacy for GDPR, iQ Profiles v3 for programmatic iQ config — GET/PATCH variables, tags, load rules, extensions)
