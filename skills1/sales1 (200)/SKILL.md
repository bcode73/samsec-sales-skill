...
- **OAuth Implicit Grant deprecation** — Token Implicit Grant (Browser) can no longer be used to create new OAuth clients from May 25, 2026, and is removed entirely on May 24, 2027. Migrate to PKCE (recommended) or another Code Authorization flow; Client Credentials for non-user services.
