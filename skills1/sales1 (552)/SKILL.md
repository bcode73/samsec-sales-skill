...
- **Partner programs**: Two tiers — Optimized starts at $100/mo, Custom at $2K/mo minimum. Set strict engagement criteria (30-day open required) to avoid paying for disengaged subscribers.
...
1. **Referral Programs are closed to new SparkLoop users (as of 2026)** — existing programs still run, but new referral programs now go through Kit (ConvertKit)'s Creator Network. Historically a $2K/year add-on (free for Kit Creator Pro).
2. **Partner Program has two tiers** — Optimized at **$100/month minimum** and Custom at **$2,000/month minimum** (these are budget allocations, not flat fees). The old "$2K/month minimum" is now just the Custom tier.
