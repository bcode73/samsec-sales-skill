...
### Referral Programs (legacy — closed to new users)
**As of 2026, Referral Programs are no longer available to new SparkLoop users.** Existing programs continue to run, and Kit (ConvertKit) users can access an equivalent referral program through **Kit's Creator Network** instead. Historically this was a $2K/year add-on (free for Kit Creator Pro). If a user asks to set up a brand-new referral program directly in SparkLoop, route them to Kit's Creator Network or a dedicated referral tool.
...
- **Kit Creator Network** — Kit (ConvertKit) users get an equivalent referral program through Kit's Creator Network (the path for new referral programs now that SparkLoop's standalone Referral Program is closed to new signups)

### Paid Recommendations (free)
Earn $2–$7+ per confirmed subscriber by recommending other newsletters to your audience. Separately, **brand Offers pay $2–$200+ per confirmed conversion** (click, lead, or action) — these are advertiser/brand deals surfaced through the same recommendation channels and tracked via the Offers API.

The free Partner Network earning surfaces are the **Signup Flow / Upscribe widget** (post-opt-in), the **Recommendations Hub** (a hosted page bundling your recommendations), and **Partner Links** (affiliate-style links for recommending a specific newsletter).
...
### Partner Programs (two tiers)
Get other newsletters to recommend yours — the reverse of paid recommendations.
- **Optimized Partner Program** — **$100/month minimum**. The lower-barrier entry tier; access via the Upscribe widget and Partner Network.
- **Custom Partner Program** — **$2,000/month minimum**. The full managed tier (the historical "minimum"; now the higher of two tiers).
...
| Feature | Price | Notes |
|---|---|---|
| Paid Recommendations | Free | Earn $2-$7+ per confirmed subscriber. SparkLoop takes 20% + 3.5% fees |
| Brand Offers | Free | Earn $2–$200+ per confirmed conversion (click/lead/action) |
| Free Recommendations | Free | Unpaid cross-promotion |
| Partner Program — Optimized | $100/month minimum | Lower-barrier tier; Upscribe + Partner Network access |
| Partner Program — Custom | $2,000/month minimum | Full managed tier |
| Referral Programs | Closed to new users | Legacy; Kit users use Kit's Creator Network instead. Historically $2K/year (free for Kit Creator Pro) |
| API access | Included | 120 requests per 60 seconds rate limit |

**Historical note**: Earlier pricing showed plans starting at $99/month, then a flat $2K/year Referral Program add-on. As of 2026 the Referral Program is closed to new signups and the Partner Program splits into a $100/mo Optimized tier and a $2K/mo Custom tier; recommendations and brand Offers remain free to earn from.
...
- **Direct API** — full REST API v2 (`https://api.sparkloop.app/v2`) for custom implementations; covers Subscribers, Campaigns, Partner Programs, Partner Network, Publications, Upscribe (incl. recommendation pin/pause management), Offers (incl. conversion confirmation), and webhooks. An older API v1 (`/v1`) is still documented and not deprecated, but v2 is the recommended surface.
