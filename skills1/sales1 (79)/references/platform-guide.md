...
| **Backlinks** | Backlink counts for articles/domains | API-accessible (via Search API — not a separate API) |
...
| Plan | Monthly (annual) | Users | Searches/mo | Alerts | Key gates |
|---|---|---|---|---|---|
...
| **Enterprise** | $999 | 30 | Unlimited | 50 | RSS Feed Sync, Granular Location Search, Early Access to Beta Features |

<!-- Alert counts verified against buzzsumo.com/pricing 2026-06-13: Content Creation 2, PR & Comms 5, Suite 10, Enterprise 50. -->
<!-- All prices billed annually; Enterprise is annual billing only. -->

> Pricing verified against [buzzsumo.com/pricing](https://buzzsumo.com/pricing/) on 2026-06-13.
...
| **API** | Bidirectional | Two REST APIs — Search API (content, influencers, trending, sharers, backlink counts) and Account API (alerts, projects) |
