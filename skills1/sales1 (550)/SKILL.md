...
- **Real-time transcription.** The official homepage now states "Sonnet records and transcribes in real-time" — earlier docs described post-call-only processing, so this changed. Notes/insights are still finalized after the call ends.
