...
- **Ticket sync delay.** Zendesk tickets typically take 1-3 hours to sync. By default only tickets updated within the last 30 days are kept in the app database. Plan QA workflows around this lag.
