...
**Sync behavior**: By default, tickets updated within the last 30 days are kept in the app database (adjustable on some integrations). Zendesk tickets typically sync with 1-3 hours of latency.
...
Go to Integrations > select your platform > authenticate. Tickets will begin syncing within hours. By default, only tickets updated in the last 30 days are kept in the app database (this window is adjustable on some integrations).
