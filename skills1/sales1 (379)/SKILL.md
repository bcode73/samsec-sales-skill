...
- **No API, no webhooks, no CRM.** Zero integration surface. You cannot programmatically access transcripts, export to a CRM, or automate workflows. The only export is manual: PDF export and the iOS share sheet, one note at a time.
