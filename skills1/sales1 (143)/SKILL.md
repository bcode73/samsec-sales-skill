...
| Open source | Yes — github.com/MarsX-dev/devhunt (419+ stars) |
...
**Note**: DevHunt is collaborative and open-source — per the official repo (github.com/MarsX-dev/devhunt), listings are handled via GitHub pull requests and user logins are used for genuine voting. Submitting through the web form is the standard path; the PR mechanism reflects the platform's open-source listing model.
