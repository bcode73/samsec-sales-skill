...
## Rate Limits (daily)
- Starter (Free): 1,000 requests
- Bronze: 10,000
- Silver: 50,000
- Gold: 100,000
- Enterprise: Unlimited (no documented daily API call limit)
- Count resets at midnight Eastern Time (EST)
...
- Enables Claude/Cursor/VS Code to interact with Jotform forms and submissions directly
- Hosted endpoint: `https://mcp.jotform.com` — point any MCP-compatible client at it
- Auth: OAuth 2.0 only (Bearer-token access is NOT supported; OAuth consent runs through a Jotform App on first connect)
- Tools exposed: list forms, create form, edit form, create submission, get submissions
