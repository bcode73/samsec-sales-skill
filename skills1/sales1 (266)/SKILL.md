...
- A) Starter/Free (5 forms, 100 submissions/mo)
- B) Bronze ($39/mo, 25 forms, 1K submissions/mo)
- C) Silver ($49/mo, 50 forms, 2.5K submissions/mo)
- D) Gold ($129/mo, 100 forms, 10K submissions/mo, HIPAA)
- E) Enterprise (custom pricing, unlimited forms/submissions)
- F) Not sure
...
5. **HIPAA requires Gold plan** — Gold ($129/mo, or $99/mo billed annually) is the minimum for HIPAA compliance. Starter through Silver plans cannot be used for PHI.
