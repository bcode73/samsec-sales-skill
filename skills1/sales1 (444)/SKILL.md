...
- **Don't ignore the 90-day dedup.** Prospeo doesn't charge for re-enriching the same record within 90 days. If you need updated data on someone you've already enriched in that window, re-run the enrichment for free. After 90 days, re-enriching the same record uses credits again. This dedup is per-account, not per-team-member.
