...
<!-- Source: https://referralkit.co (homepage; /pricing and /plans both return HTTP 404) and the official AWeber partner page https://www.aweber.com/integrations/other/referralkit/, plus third-party comparisons (viral-loops.com SparkLoop alternatives roundup, IndieHackers thread, todaytesting.com SparkLoop review). Research date 2026-05-30; API/pricing/ESP claims re-verified 2026-06-13 (no drift). Pricing model and ESP integration list may shift; verify before quoting hard numbers. -->
...
<!-- Pricing data uncertain. Homepage (verified 2026-06-13) states "100% free for your first 10,000 leads." /pricing AND /plans both return HTTP 404. The official AWeber partner page (aweber.com/integrations/other/referralkit/, verified 2026-06-13) instead describes a "30-day free trial" including "200 subscribers, unlimited referrals, unlimited rewards, and unlimited team members" — a trial-based model that coexists with the homepage free-10K claim. Older third-party sources also mention "$19/mo for 3K subs." These framings conflict; verify the live model with support before quoting hard numbers. -->
...
**Free trial**: The official AWeber partner page (verified 2026-06-13) still describes a "30-day free trial" with 200 subscribers, while the homepage advertises a permanent "free for your first 10,000 leads" tier. Both framings are live simultaneously — confirm the actual current model with support before quoting.
