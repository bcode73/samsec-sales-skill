...
**Compatibility**: Revive Adserver v4.x, v5.x, v6.x (latest v6.0.6, March 2026). The 11 XML-RPC service files — Advertiser, Agency, Banner, Campaign, Channel, Logon, Publisher, Tracker, User, Variable, Zone — are still present and unchanged in v6.0; the v6.0 release did not modify the XML-RPC API.
...
**Pricing**: US$249/year subscription or US$599 lifetime license
**Auth**: Base64 `user:password` in Authorization header
**Format**: JSON
**Compatibility**: Revive v4.x, v5.x, v6.x; all supported PHP 7 and PHP 8 versions
