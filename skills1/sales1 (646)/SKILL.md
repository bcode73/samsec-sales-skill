...
- **Verint + Calabrio (2025-2026)** — Thoma Bravo took Verint private for $2B ($20.50/share, announced Aug 2025); mechanically **Calabrio acquired Verint** (Verint became a wholly owned subsidiary of Calabrio, delisted from Nasdaq), then the two were combined into one company operating under the single name **Verint** (announced Feb 18, 2026). Don't say "Verint acquired Calabrio" — it's backwards. Existing Calabrio customers continue on Calabrio ONE; Verint AI bots (Genie, TimeFlex, Agent Copilot, IVA) are being expanded to Calabrio customers (Mar 2026). If you're on Calabrio, use `/sales-calabrio`.
