...
## Marketing Platform pricing (verified 2026-06-13)
Tiers: **Free / Starter / Standard / Professional / Enterprise**. Billed by email volume sent, not contacts stored.
- **Free**: $0 — 300 emails/day (daily cap, ~9,000/mo), unlimited contacts stored.
- **Starter**: from $9/mo for 5,000 emails/mo, stepping up to $69/mo for 100K. Removes the daily cap. No automation, A/B testing, or landing pages.
- **Standard**: from $18/mo for 5,000 emails/mo (to $129/mo for 100K). Adds marketing automation, A/B testing, advanced statistics + heatmaps, AI send-time optimization, web tracking, landing pages, and removes Brevo branding. (This is the tier the feature gates below call "Standard plan+".)
- **Professional**: from $499/mo — high-volume multichannel, 150K–10M emails/mo.
- **Enterprise**: custom — sub-accounts, SSO/SAML, dedicated support, advanced security. (Sales CRM, Conversations, and a transactional-email free tier exist alongside these on their own packaging.)
