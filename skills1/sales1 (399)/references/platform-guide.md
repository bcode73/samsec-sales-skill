...
| Unlimited roleplay bots | ✓ (Cold, Discovery + 11 more; 12 defined AI roleplay agents) | ✓ | ✓ |
| AI Bot builder + 1-click variations | ✓ | ✓ | ✓ |
| Unlimited call time + full transcription | ✓ | ✓ | ✓ |
...
| Gamified Learning | — | ✓ | ✓ |
| Chat, Video, In-Person Roleplay Modes | — | ✓ | ✓ |
| Build AI agents from calls/prompts/templates | — | ✓ | ✓ |
| Software / Workflow Simulation | — | ✓ | ✓ |
| Background Environments | — | ✓ | ✓ |
| 55+ Call Recording Integrations | — | ✓ | ✓ |
| Multi-Persona Roleplays | — | ✓ | ✓ |
| Custom AI Scorecards & Call Scenarios | — | ✓ | ✓ |
| Course Certifications & Call Drills | — | ✓ | ✓ |
| Video AI Avatars | — | ✓ | ✓ |
| POC Available | — | — | ✓ |
...
**Billing model**: Per-seat pricing based on active users (reps, managers, enablement staff). No exact prices published — all paid tiers are custom-quoted; contact sales. Annual contracts standard, multi-year available for enterprise. Integrations (150+ systems) included at no additional fee. No platform fee, no support fee.

**Trial / sandbox**: Free, unrestricted 14-day trial on Premium and Enterprise plans. Free evaluation sandbox at `playground.outdoo.ai/sales-roleplay` — no signup required to try roleplays before committing.
...
### LMS (15+ platforms)
TalentLMS, Docebo, Cornerstone OnDemand, Absorb LMS, Totara Learn, Oracle Learning, SAP Litmos, Workday Learning, D2L Brightspace, Skillsoft Percipio, CYPHER Learning, Paradiso LMS, iSpring Learn, Thinkific Plus, Degreed (plus more). SCORM and xAPI standards supported.

### LMS authoring (7 platforms)
Articulate, Adobe Captivate, iSpring Suite, Elucidat, Lectora, Camtasia, Easygenerator
...
**Total**: 150+ integrations across categories (per outdoo.ai/pricing).
...
- Customer/user data never used for AI training
- SSO via Google, Microsoft OAuth, SAML 2.0, OIDC (Enterprise)
- Role-based access controls, full audit logging
- Enterprise: private cloud deployment, SSO, custom branding
