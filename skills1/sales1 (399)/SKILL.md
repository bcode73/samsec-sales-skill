...
- **Pricing is custom/opaque.** No public per-seat pricing — budget ~$660-1,200/user/year based on comparison data. No platform fee (vs Gong's $10K). To evaluate before committing: 14-day free trial on Premium/Enterprise, plus a free sandbox at `playground.outdoo.ai/sales-roleplay`.
