...
- `/sales-syncgtm` — SyncGTM platform help (AI-native GTM engine: buyer signals + waterfall enrichment + AI lead scoring + Workflow Builder; MCP server `api.syncgtm.com/mcp` (OAuth, works with Claude Code) + REST API + webhooks + 40+ integrations; free tier, ~$99/mo)
