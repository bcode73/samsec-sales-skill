...
- **Rate limits.** 60 req/min and 10,000/day per token (higher limits available on request for production integrations). For backfills, use `POST /v1/sessions/bulk` (up to 50 sessions) instead of individual fetches.
