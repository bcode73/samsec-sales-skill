...
- **Jitterbit Studio** (web-based, recommended for new work; formerly **Integration Studio** / Cloud Studio — the official docs and UI now call it "Jitterbit Studio"): Modern browser-based designer for building integration projects and AI agents. Workflow design, design canvas, component palette, script editor. Access at `https://login.jitterbit.com`.
...
- **App Builder** (formerly **Vinyl**): No-code application development — forms, tables, lists, business logic. Data, business, UI, and security layers. AI assistant for building apps.
...
- **APAC**: APAC Southeast (Asia-Pacific, including Australia). Portal: `apps.apac-southeast.jitterbit.com`. (The portal/REST subdomain is `apac-southeast`, not `apac-east`.)
...
### AI bundle options (2025-2026)

Per the official iPaaS product page, the four bundles are:

- **Harmony AI Bundle**: Unified Harmony access (note: the official name is "Harmony AI Bundle", not "AI Harmony Bundle").
- **iPaaS AI Bundle**: Integration-focused.
- **App Builder AI Bundle**: App Builder-focused.
- **Harmony EDI Bundle**: EDI/B2B-focused.
...
- No automatic conversion tool. Studio projects are not backwards-compatible with Design Studio — projects must be rebuilt.
- Jitterbit offers a **free migration evaluation** (the Studio Readiness Team reviews projects and estimates cost) plus a paid migration service; you can also rebuild from scratch in Studio.
...
- Note: Jitterbit has **not** announced an end-of-life for Design Studio; it remains supported.
