...
| **AI credits** | 7,500/seat/mo | 15,000/seat/mo | Custom |
...
**25% discount** for verified students and non-profits. Free trial, no free plan. Annual billing saves 33% vs monthly.

**AI credits warning**: Heavy use of AI Chat, Docs writing, and meeting notes can consume credits faster than expected. Users report 20-40% bill increases from AI feature usage. Monitor in Settings. Credits are NOT consumed by creating projects/tasks or by auto-scheduling — only the advanced AI tools (AI Chat, Meeting Notetaker, AI Docs writer/editor) draw them down. Once the monthly allotment is exhausted, overage is billed per 100 credits: **Pro AI $0.25/100 credits, Business AI $0.19/100 credits** (per usemotion.com/pricing, verified 2026-06-13).
