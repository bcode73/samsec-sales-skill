...
RedShip supports HTTPS webhook push notifications. Configuration is in the dashboard settings. **Webhooks are gated to the Company plan ($79/mo)** — the Founder plan ($29/mo) only has Email & Slack alerts (verified on https://redship.io/pricing, 2026-06-13).

**What's documented:**
- Webhook URL must be HTTPS
- Fires when new inbox items are detected
- Requires the Company plan
