...
TOC_STRUCTURE = [
    ...
    ("Worksheets", "worksheets-full", [
        ("Worksheet 1: Myth Audit", "worksheet-1"),
        ("Worksheet 2: Buying Committee Map", "worksheet-2"),
        ("Worksheet 3: Trust Audit", "worksheet-3"),
        ("Worksheet 4: Discovery Questions", "worksheet-4"),
        ("Worksheet 5: Problem Diagnosis", "worksheet-5"),
        ("Worksheet 6: Value Stack Builder", "worksheet-6"),
        ("Worksheet 7: Offer Builder", "worksheet-7"),
        ("Worksheet 8: Objection Resolution", "worksheet-8"),
        ("Worksheet 9: Action Friction Audit", "worksheet-9"),
        ("Worksheet 10: Nurture Cadence Planner", "worksheet-10"),
        ("Worksheet 11: Referral Ask Builder", "worksheet-11"),
        ("Worksheet 12: Digital Signal Audit", "worksheet-12"),
        ("Worksheet 13: Pipeline Rebuild", "worksheet-13"),
        ("Worksheet 14: Thirty-Day Rollout Planner", "worksheet-14"),
    ]),
